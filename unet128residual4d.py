...
callbacks_NW = [
    ...
    ModelCheckpoint(filepath='weights/unet128residual_NW_4d.h5', monitor='val_loss', save_weights_only=True, save_best_only=True, verbose=1),
    TestCallbackGaussian(test_gen_NW, residual_n_mean, residual_n_std, 'results/callbackUnet128res_NW_4d.npz', 10)
]
callbacks_NE = [
    EarlyStopping(monitor='val_loss', patience=20, verbose=1, restore_best_weights=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=10, verbose=1, min_lr=1e-5, min_delta=1e-3),
    ModelCheckpoint(filepath='weights/unet128residual_NE_4d.h5', monitor='val_loss', save_weights_only=True, save_best_only=True, verbose=1),
    TestCallbackGaussian(test_gen_NE, residual_n_mean, residual_n_std, 'results/callbackUnet128res_NE_4d.npz', 10)
]
callbacks_SW = [
    EarlyStopping(monitor='val_loss', patience=20, verbose=1, restore_best_weights=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=10, verbose=1, min_lr=1e-5, min_delta=1e-3),
    ModelCheckpoint(filepath='weights/unet128residual_SW_4d.h5', monitor='val_loss', save_weights_only=True, save_best_only=True, verbose=1),
    TestCallbackGaussian(test_gen_SW, residual_n_mean, residual_n_std, 'results/callbackUnet128res_SW_4d.npz', 10)
]
callbacks_SE = [
    EarlyStopping(monitor='val_loss', patience=20, verbose=1, restore_best_weights=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=10, verbose=1, min_lr=1e-5, min_delta=1e-3),
    ModelCheckpoint(filepath='weights/unet128residual_SE_4d.h5', monitor='val_loss', save_weights_only=True, save_best_only=True, verbose=1),
    TestCallbackGaussian(test_gen_SE, residual_n_mean, residual_n_std, 'results/callbackUnet128res_SE_4d.npz', 10)
]

# LOAD WEIGHTS
#model.load_weights('weights/unet256residual_NW_4d.h5')
#model.load_weights('weights/unet256residual_NE_4d.h5')
#model.load_weights('weights/unet256residual_SW_4d.h5')
#model.load_weights('weights/unet256residual_SE_4d.h5')
